...
function UsedByAdminProductsScreen () {
  ...
  async function fetchData() {
    try {
      const response = await axios.get(
        `${SERVER_URL}/api/v1/analytics/admin-used`,
        {
          params: {
            page: currentPage,
  ...
  return (
    <div className="m-5">
      <div>
        <h1 className="text-3xl font-semibold text-neutral-900">Used By Admin</h1>
...
export default UsedByAdminProductsScreen;
