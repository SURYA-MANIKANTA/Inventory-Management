...
function NotInUseProductsScreen() {
  ...
  return (
    <div className="m-5">
      <div>
        <h1 className="text-3xl font-semibold text-neutral-900">Not In Use</h1>
            ...
            <tbody>
              {isLoading ? (
                <tr>
                 ...
                 products.filter((product)=>product.history[0].status[0].name==='not in use')
                  .map((product, idx) => (
                  <ProductRow
                    key={product._id}
                    index={idx}
...
export default NotInUseProductsScreen;
