...
function UsedByDepartmentProductsScreen () {
  ...
  async function fetchData() {
    try {
      const response = await axios.get(
        `${SERVER_URL}/api/v1/analytics/used-by-department`,
        {
          params: {
            page: currentPage,
  ...
  return (
    <div className="m-5">
      <div>
        <h1 className="text-3xl font-semibold text-neutral-900">Used By Department</h1>
...
export default UsedByDepartmentProductsScreen ;
