...
function UsedByNormalUserProductsScreen () {
  ...
  async function fetchData() {
    try {
      const response = await axios.get(
        `${SERVER_URL}/api/v1/analytics/used-by-normal-user`,
        {
          params: {
            page: currentPage,
  ...
  return (
    <div className="m-5">
      <div>
        <h1 className="text-3xl font-semibold text-neutral-900">Used By Normal User</h1>
...
export default UsedByNormalUserProductsScreen ;
