...
function InWarrantyProductsScreen() {
  ...
  async function fetchData() {
    try {
      const response = await axios.get(
        `${SERVER_URL}/api/v1/analytics/in-warranty-products`,
        {
          params: {
            page: currentPage,
  ...
  return (
    <div className="m-5">
      <div>
        <h1 className="text-3xl font-semibold text-neutral-900">In Warranty</h1>
...
export default InWarrantyProductsScreen;
